  ...
  async (message, args) => {
    try {
      ...
      if (url.toLowerCase().includes("https")) {
        ...
        return await message.send("`RIAS_GREMORY-BOT UPDATE WAS SUCCESSFULL ✅`");
      } else {
            ...
            nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
              buttons: [
                ...
                },
                {
                  ...
                  buttonParamsJson: JSON.stringify({
                    display_text: "𝐁𝐎𝐓 ",
                    url: `https://github.com/Toxic1239/RIASGREMORYBOT`
                  })
                },
            contextInfo: {
  ...
  async (m) => {
    try {
      ...
      const contextInfo = {
        isForwarded: true,
        forwardingScore: 999,
        title: "RIAS_GREMORY-BOT Running Since",
        body: message,
        footerText: "RIAS_GREMORY-BOT 2024",
...
astro_patch.cmd({
    ...
    try {
      ...
      let _0x95885d = "\n\t*RIAS_GREMORY-BOT ᴄᴏᴍᴍᴀɴᴅs ɪɴғᴏ*  \n";
    ...
    try {
      ...
      if (!isNaN(_0x56b5d3)) {
        if (
          ...
          _0x1eb88a[1][_0x210c92(362)]("RIAS_GREMORY-BOT_FANCY_TEXT")
        ) {
